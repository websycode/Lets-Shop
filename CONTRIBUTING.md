...
- Take a look at the Existing [Issues](https://github.com/websycode/Lets-Shop.git) or create your own Issues!
- Wait for the Issue to be assigned to you after which you can start working on it.
- Fork the Repo and create a Branch for any Issue that you are working upon.
- Read the [Code of Conduct](https://github.com/websycode/Lets-Shop.git)
...
4. Fork the [repository](https://github.com/websycode/Lets-Shop).
...
Congratulations🎉, you have made a PR to the Lets-Shop.
